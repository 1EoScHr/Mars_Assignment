...
# 1. 加载模型权重或对象
pre = torch.load("resources/pretrained/backbone/pre_model.pth", map_location="cpu", weights_only=False)
my_state_dict = torch.load("resources/pretrained/backbone/my_weights.pth", map_location="cpu", weights_only=False)
